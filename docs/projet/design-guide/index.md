...
| **Vie privée d’abord** (_Privacy first_) | Favorise le traitement local. Pour évaluer rapidement l’exposition au cloud d’une intégration, s’appuyer sur la [classification Home Assistant](https://www.home-assistant.io/blog/2016/02/12/classifying-the-internet-of-things/#classifiers) (classifiers : Local Push/Local Polling/Cloud Push/Cloud Polling). Si du cloud est utilisé, le faire en connaissance de cause et limiter les données partagées au strict nécessaire. |
